...
export default function InvestmentSpace() {
  ...
  const loadPositions = async () => {
    try {
      const res = await fetch('http://localhost/figtop-api/admin_get_positions.php');
  ...
  const updatePercentOverride = async () => {
    ...
    try {
      ...
      const res = await fetch('http://localhost/figtop-api/admin_modify_trade.php', { method: "POST", body: formData });
